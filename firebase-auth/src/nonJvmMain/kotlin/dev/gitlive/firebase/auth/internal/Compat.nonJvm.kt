...
internal actual fun UserInfo.photoUrlString(): String? = photoUrl

internal actual fun UserProfileChangeRequest.Builder.setPhotoUrlString(url: String?): UserProfileChangeRequest.Builder = setPhotoUri(url)
