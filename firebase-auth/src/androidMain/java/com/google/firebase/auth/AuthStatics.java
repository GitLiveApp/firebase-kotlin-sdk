...
final class AuthStatics {
    ...
    static void verifyPhoneNumber(PhoneAuthOptions options) { PhoneAuthProvider.verifyPhoneNumber(options); }
    static ActionCodeSettings.Builder actionCodeSettingsBuilder() { return ActionCodeSettings.newBuilder(); }
}
