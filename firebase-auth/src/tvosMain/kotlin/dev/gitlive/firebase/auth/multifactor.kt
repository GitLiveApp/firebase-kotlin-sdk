...
public actual class MultiFactor {
    ...
    public actual suspend fun unenroll(multiFactorInfo: MultiFactorInfo): Unit = throw TvOsMultifactorNotSupportedException()
    public actual suspend fun unenroll(factorUid: String): Unit = throw TvOsMultifactorNotSupportedException()
}
