...
kotlin {
    ...
    sourceSets {
        ...
        val androidMain by getting {
            dependencies {
                val firebaseConfigVersion: String by project
        ...
        configure(listOf(iosArm64, iosX64)) {
            compilations.getByName("main") {
                ...
                val firebaseConfig by cinterops.creating {
                    packageName("cocoapods.FirebaseRemoteConfig")
                    defFile(file("$projectDir/src/iosMain/c_interop/FirebaseRemoteConfig.def"))
