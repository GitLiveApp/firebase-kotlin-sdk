...
| [Cloud Firestore](https://firebase.google.com/docs/firestore)                   | [`dev.gitlive:firebase-firestore:2.7.0`](https://search.maven.org/artifact/dev.gitlive/firebase-firestore/2.7.0/pom)         | [![100%](https://img.shields.io/badge/-100%25-green?style=flat-square)](/firebase-firestore/src/commonMain/kotlin/dev/gitlive/firebase/firestore/firestore.kt)            |
...
`firebase-installations` and `firebase-firestore`; the other modules are migrated one by one. A member marked `@unavailable` in a
module's `api/android-sdk/exclusions.txt` (such as the Firestore pipeline API and vector values) does not exist in the pinned iOS or
JS SDK and is left out of the coverage count. For a step-by-step walkthrough of moving Android SDK code
