...
/** Not supported on wasmJs, where the options cannot be read from a default configuration: always throws. */
...
public actual fun Firebase.getApps(context: Any?): List<FirebaseApp> = jsGetApps().toList().map { FirebaseApp(it) }
