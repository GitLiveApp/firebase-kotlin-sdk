 ...
 * `fromResource` reads Android resources and can only be called from Android code.
 */
public expect class FirebaseOptions {
    ...
    public companion object {
        /** Android only: reads the options from the resources generated by the Google Services Gradle plugin. */
