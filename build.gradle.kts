    ...
    tasks {
        ...
        val copyJS by registering {
            ...
            doLast {
                ...
                into.writeText(
                    from.readText()
                        .replace("require('firebase-", "require('@gitliveapp/firebase-")
                    //                .replace("require('kotlinx-serialization-kotlinx-serialization-runtime')", "require('@gitliveapp/kotlinx-serialization-runtime')")
                )
            }
        }
